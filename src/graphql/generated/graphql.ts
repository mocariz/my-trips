...
export type PlaceManyWhereInput = {
  ...
  visited?: InputMaybe<Scalars['Boolean']>;
  /** All values that are not equal to given value. */
  visited_not?: InputMaybe<Scalars['Boolean']>;
};
